...
Abra la URL de la Application en el navegador para ver la guía inicial y probar
el modelo con texto, una imagen opcional y parámetros de generación. La página
también incluye ejemplos de `curl` y Python. La guía se sirve en `/`; la API y
el esquema interactivo de vLLM siguen disponibles en `/v1/*` y `/docs`.
